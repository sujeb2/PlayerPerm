...
public class CustomRecipeFileConfiguration {
    ...
    public void createItem() throws NullPointerException {
        ...
        var getLoc = Objects.requireNonNull(configRecipe.getConfigurationSection("*")).getKeys(false);
        String itemName = configRecipe.getString(getLoc + ".name");
        String itemLore1 = configRecipe.getString(getLoc + "lore");
        String itemLore2 = configRecipe.getString(getLoc + ".lore2");
        item = configRecipe.getString(getLoc + ".item");
